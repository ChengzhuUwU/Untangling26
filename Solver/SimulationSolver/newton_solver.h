...
namespace lcs
{
	...
	private:
		...
		void host_interpulate_dx_dq_from_scalar(const float alpha);
		void host_interpulate_dx_dq_from_array(const std::vector<float>& toi_buffer);
		void device_interpulate_dx_dq_from_scalar(luisa::compute::Stream& stream, const float alpha);
		void device_interpulate_dx_dq_from_array(luisa::compute::Stream& stream, luisa::compute::Buffer<float>& toi_buffer);
	...
	private:
		...
		luisa::compute::Shader<1, luisa::compute::BufferView<float>, float> fn_scaling_toi;
		...
		luisa::compute::Shader<1, float, float3, bool, bool>													fn_predict_position; // const Float substep_dt, const Float3 gravity, const Bool use_quasi_static_mode, const Bool use_static_mode
		...
		luisa::compute::Shader<1, float, bool, bool>															fn_gound_collision_ccd;
		...
		luisa::compute::Shader<1, luisa::compute::Buffer<float3>, luisa::compute::Buffer<float3>, luisa::compute::Buffer<float3>, float> fn_interpolate_from_scalar;
		...
		luisa::compute::Shader<1,
			...
			luisa::compute::Buffer<float3>,		   // sa_x_iter_start
			luisa::compute::Buffer<float3>,		   // sa_dx
			luisa::compute::Buffer<float>,		   // sa_toi
			luisa::compute::Buffer<VertexToDofMap> // sa_x_to_dof_map
			>
			fn_interpolate_dx;

		luisa::compute::Shader<1,
			luisa::compute::Buffer<float3>,		// sa_q
			luisa::compute::Buffer<float3>,		// sa_q_iter_start
			luisa::compute::Buffer<float3>,		// sa_dq
			luisa::compute::Buffer<float>,		// sa_toi
			luisa::compute::Buffer<DofProperty> // sa_dof_property
			>
			fn_interpolate_dq;
	};
