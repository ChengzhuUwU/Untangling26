...
{
template <typename T>
inline void point_point_distance2(const Eigen::Vector<T, 3>& a,
...
template <typename T>
inline void point_point_distance2_gradient(const Eigen::Vector<T, 3>& a,
                                                 const Eigen::Vector<T, 3>& b,
...
template <typename T>
inline void point_point_distance2_hessian(const Eigen::Vector<T, 3>& a,
                                                const Eigen::Vector<T, 3>& b,
