...
namespace lcs
{
	...
	struct MeshData : SimulationType
	{
		...
		BufferType<float2> sa_material_x;
		...
		BufferType<uint> sa_mesh_orientation;
		...
		BufferType<float> sa_fixed_stiffness;
		...
		BufferType<uint4> edge_adj_edges;
		BufferType<uint3> face_adj_edges;
		BufferType<uint3> face_adj_faces;
		BufferType<uint>  edge_adj_faces_csr;
		BufferType<uint>  edge_adj_edges_csr;
		BufferType<uint>  face_adj_faces_csr;
		...
		std::vector<uint> vert_topology_component_id;
		...
		std::vector<std::vector<uint>> edge_adj_faces_ext;
		std::vector<std::vector<uint>> edge_adj_edges_ext;
		std::vector<std::vector<uint>> face_adj_faces_ext;
