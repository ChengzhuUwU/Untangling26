...
namespace lcs
{
	...
	public:
		...
		uint get_inner_dof_offset() const { return (attribute_info >> 16) & 0xF; }
	...
	public:
		...
		void set_dof_offset(const uint offset)
		{
			attribute_info = (attribute_info & 0xFFFF) | ((offset & 0xF) << 16);
		}
	};
...
LUISA_STRUCT(lcs::DofProperty, attribute_info)
{
	...
	luisa::compute::Var<uint> get_inner_dof_offset() const { return (attribute_info >> 16) & 0xF; }
};
// clang-format on
