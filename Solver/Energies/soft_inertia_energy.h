...
namespace lcs
{
	...
	public:
		SoftInertiaEnergy(luisa::compute::BufferView<float3> sa_q_tilde_view,
			luisa::compute::BufferView<uint>				 sa_q_is_fixed_view,
	...
	private:
		luisa::compute::BufferView<uint>																										   _sa_q_is_fixed_view;
		luisa::compute::BufferView<float3>																										   _sa_q_tilde_view;
		luisa::compute::BufferView<float>																										   _sa_system_energy_view;
		luisa::compute::Shader<1, Constitutions::SoftInertia<luisa::compute::Buffer>, luisa::compute::BufferView<float3>, float, bool, uint>	   _shader;
		luisa::compute::Shader<1, Constitutions::SoftInertia<luisa::compute::Buffer>, luisa::compute::BufferView<float3>, float, bool, bool, uint> _eval_shader;
	};
