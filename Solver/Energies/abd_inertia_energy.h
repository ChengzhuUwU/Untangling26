...
namespace lcs
{
	...
	public:
		AbdInertiaEnergy(luisa::compute::BufferView<float3> sa_q_tilde,
			luisa::compute::BufferView<uint>				sa_q_is_fixed,
	...
	private:
		luisa::compute::BufferView<uint>																										  _sa_q_is_fixed;
		luisa::compute::BufferView<float3>																										  _sa_q_tilde;
		luisa::compute::BufferView<float>																										  _sa_system_energy;
		luisa::compute::Shader<1, Constitutions::AbdInertia<luisa::compute::Buffer>, luisa::compute::BufferView<float3>, float, bool, uint>		  _shader;
		luisa::compute::Shader<1, Constitutions::AbdInertia<luisa::compute::Buffer>, luisa::compute::BufferView<float3>, float, bool, bool, uint> _eval_shader;
	};
